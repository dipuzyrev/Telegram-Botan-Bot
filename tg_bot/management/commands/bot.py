...
def do_start(update: Updater, context: CallbackContext):
	...
	update.message.reply_html(
		text='<i>Ботан на удалёнке</i> — это фриланс биржа для студентов в формате чат-бота.\n\n' \
			 'Если нужен какой-нибудь реферат по экологии, но совсем не до этого — делегируй это. Жми:\n' \
			 '📝 <b>Создать заказ</b>\n\n' \
			 'Если, например, разбираешься в <i>физике</i>, задай ключевое слово Физика и зарабатывай, '
			 'выполняя заказы. Жми:\n' \
			 '⚙️ <b>Настройки</b>\n\n' \
			 'Если возникли проблемы, появились идеи или хочешь предложить сотрудничество — с радостью выслушаем, '
			 'поможем. Жми:\n' \
			 '👨‍💻 <b>Поддержка</b>\n\n' \
			 'С остальным легко разберёшься самостоятельно. Погнали!',

...
def do_start(update: Updater, context: CallbackContext):
	...
	update.message.reply_html(
		text='Коротко о главном:\n\n'
			 '📝 <b>Новый заказ</b> — создаём задание и ждём заявок от исполнителей. Оплачиваем. '
			 'Получаем результат. Done.\n\n'
			 '⚙️ <b>Настройки</b> — здесь можно задать ключевые слова и получать уведомления о новых заказах. '
			 'Получили уведомление, назначили цену, выполнили заказ, получили денежку на счёт.\n\n'
			 '💵 <b>Баланс</b> — собственно, сюда капает денежка с выполненных заказов.\n\n'
			 '🔢 <b>Статистика</b> — твой рейтинг как исполнителя и другие интересные циферки.\n\n'
			 '👨‍💻 <b>Поддержка</b> — сюда <s>можно</s> нужно смело обращаться с любой проблемой, идеей или '
			 'предложением.',
